...
class ReadmeFormattingTest {
    ...
    @Test
    void formatUnitWithPatternAndLocale() {
    ...
    @Test
    void formatWithoutCreatingUnit() {
    ...
    @Test
    void formatWithoutCreatingUnitUsingCustomPattern() {
        final long numberOfBytes = 1_000_000_000_000_000L;
    ...
    @Test
    void formatWithoutCreatingUnitUsingCustomPatternWithSpecificLocale() {
        final long numberOfBytes = 1_000_000_000_000_000L;
    ...
    @Test
    void formatWithoutCreatingUnitUsingCustomFormat() {
        final var customFormat = new DecimalFormat("#.00000");
        final long numberOfBytes = 1_000_000_000_000_000L;
