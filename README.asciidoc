...
image:https://img.shields.io/travis/sebhoss/storage-units/master.svg?style=flat-square["Build Status", link="https://travis-ci.org/sebhoss/storage-units"]
...
Be wary of integer overflow when working with `long`. To be safe, always use `BigInteger`.
