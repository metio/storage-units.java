...
public class StorageUnitsFormattingWithAnyFormatTest {
    ...
    /**
     * Tests formatting a {@link BigInteger} formatted as a storage unit with any format.
     *
     * @param input
    ...
    /**
     * Tests formatting a {@link Long} formatted as a storage unit with any format.
     *
     * @param input
     *            The test inputs to use.
     */
