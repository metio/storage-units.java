...
/**
 * Converter for binary storage units.
 */
public final class BinaryStorageUnitConverter implements CustomConverter {
  ...
  public Object convert(
    ...
    throw new MappingException("Converter BinaryStorageUnitConverter "
