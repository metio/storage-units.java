...
import static de.xn__ho_hia.storage_unit.TestObjects.longBasedConstructors;
 ...
 * comparing one unit with another.
 */
...
public class StorageUnitCompareToTest {
    ...
    /**
     * Ensures that comparing a smaller to a bigger unit yields the correct
     * comparison result.
     *
     * @param first
    ...
    /**
     * Ensures that comparing a bigger to a smaller unit yields the correct
     * comparison result.
     *
     * @param first
     *            The constructor function for the storage unit under test.
    ...
    /**
     * Ensures that comparing two equally sized units yields the correct
     * comparison result.
     *
     * @param first
     *            The constructor function for the storage unit under test.
