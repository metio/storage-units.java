...
import static de.xn__ho_hia.storage_unit.TestObjects.highLevelBigIntegerBasedConstructors;
...
/**
 * Test cases for the {@link StorageUnits} class that work with
 * {@link BigInteger}s.
 */
...
public class StorageUnitsWithBigIntegerTest {
    ...
    /**
     * Ensures that high-level constructors for all given unit constructors
     * produce a not-null output when fed with a {@link BigInteger} value.
     *
     * @param constructor
